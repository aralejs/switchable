...
define("arale/switchable/0.9.12/plugins/autoplay-debug", [ "$-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    // 自动播放插件
    module.exports = {
        attrs: {
...
define("arale/switchable/0.9.12/plugins/circular-debug", [ "./effects-debug", "$-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var SCROLLX = "scrollx";
    var SCROLLY = "scrolly";
...
define("arale/switchable/0.9.12/plugins/multiple-debug", [], function(require, exports, module) {
    // 手风琴组件
    module.exports = {
        isNeeded: function() {
